...
const LikeSerieButton = ({ serieId, userId, disabled }) => {
	...
	useEffect(() => {
		const fetchLike = async () => {
			try {
				const response = await api.get("/likes/series", {
					params: { serieId, userId }
				});
...
export default LikeSerieButton;
